            ...
            <div class="login-box" style="max-width: 500px;">
                <div class="portal-badge">
                    <div class="badge-icon-box"
                        style="background-color: var(--brand-blue); width: 45px; height: 45px; border-radius: 12px; display: flex; align-items: center; justify-content: center;">
                        <i class="bi bi-shield-lock-fill" style="color: white; font-size: 1.5rem;"></i>
                    </div>
                    <span
                        style="color: var(--brand-blue); font-weight: 700; letter-spacing: 1px; margin-left: 10px;">Management
                        Registration</span>
                </div>
                ...
                <div class="login-redirect mt-4 text-center">
                    Already have an account? <a href="login-management-access.php" class="fw-bold"
