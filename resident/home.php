...
<section class="card activities-card">
    ...
    <div class="activity-list">
        <div class="activity-item" 
             data-location="Main Lobby Entrance" 
             data-device="iPhone 13 Pro" 
             data-method="Digital Key (NFC)" 
            ...
            <div class="item-top">
                ...
                <div class="item-content">
                    ...
                    <p>Access granted at the Main Entrance using your personal Digital Key...
                        <span class="full-text" style="display:none;">Access granted at the Main Entrance using your personal Digital Key. The system verified your credentials and unlocked the security gate.</span>
                    </p>
                </div>
            </div>
            <div class="item-footer">
                <span class="time">About 5 hours ago</span>
                <a href="javascript:void(0)" class="read-more activity-btn">Read More <i class="bi bi-arrow-right"></i></a>
            </div>
        </div>

        <div class="activity-item" 
             data-location="Main Lobby Exit" 
             data-device="iPhone 13 Pro" 
             data-method="Digital Key (NFC)" 
             data-status="Departure Logged">
            <div class="item-top">
                ...
                <div class="item-content">
                    ...
                    <p>Exit recorded at the Main Entrance. Your Digital Key was used to unlock...
                        <span class="full-text" style="display:none;">Exit recorded at the Main Entrance. Your Digital Key was used to unlock the outward-bound security gate.</span>
                    </p>
                </div>
            </div>
            <div class="item-footer">
        ...
        <div class="activity-item" 
             data-location="Visitor Management System" 
             data-device="Sharmagne Gamboa" 
             data-method="04-15-26, 10:00AM" 
             data-status="Lobby & Second Floor">
            <div class="item-top">
                ...
                <div class="item-content">
                    ...
                    <p>A temporary digital access code has been generated for your visitor...
                        <span class="full-text" style="display:none;">A temporary digital access code has been generated for your visitor, Sharmagne Gamboa. This pass is valid for 24 hours.</span>
                    </p>
                </div>
            </div>
            <div class="item-footer">
        ...
        <div class="activity-item" 
             data-location="North Wing Entrance" 
             data-device="iPhone 13 Pro" 
             data-method="Digital Key (NFC)" 
             data-status="Authorized">
            <div class="item-top">
                ...
                <div class="item-content">
                    ...
                    <p>Access granted at the North Wing side entrance. This entrance is restricted...
                        <span class="full-text" style="display:none;">Access granted at the North Wing side entrance. This entrance is restricted to residents only after 10:00 PM.</span>
                    </p>
                </div>
            </div>
            <div class="item-footer">
              ...
              <article class="announcement-item">
                ...
                <div class="item-body">
                  ...
                  <div class="item-footer">
                    ...
                    <a href="javascript:void(0)" class="read-more announcement-btn" 
                       data-title="Maintenance Notice" 
              ...
              <article class="announcement-item">
                ...
                <div class="item-body">
                  ...
                  <div class="item-footer">
                    ...
                    <a href="javascript:void(0)" class="read-more announcement-btn"
                       data-title="Security Update"
                       data-category="SECURITY"
                       data-date="April 6, 2026"
