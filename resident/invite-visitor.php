...
<head>
    ...
    <title>Invite Visitor | Dormitory</title>
                    ...
                    <div class="activity-list">
                        <div class="activity-item history-item">
                            <div class="item-top">
                                ...
                                <div class="item-content">
                                    <h3>Erin Zoe Regalado</h3>
                                    <p>Yesterday • 07:25 AM</p>
                                </div>
                        ...
                        <div class="activity-item history-item">
                            <div class="item-top">
                                <div class="icon-box"><i class="bi bi-person-fill"></i></div>
                                <div class="item-content">
                                    <h3>Sharmagne Gamboa</h3>
                                    <p>Yesterday • 10:35 AM</p>
                                </div>
                                <div class="chevron"><i class="bi bi-chevron-right"></i></div>
                            </div>
                        </div>
                        ...
                        <div class="activity-item history-item">
                            <div class="item-top">
                                <div class="icon-box"><i class="bi bi-person-fill"></i></div>
                                <div class="item-content">
                                    <h3>Gwyneth Miasco</h3>
                                    <p>Yesterday • 12:47 PM</p>
                                </div>
                                <div class="chevron"><i class="bi bi-chevron-right"></i></div>
                            </div>
                        </div>
                        ...
                        <div class="activity-item history-item">
                            <div class="item-top">
                                <div class="icon-box"><i class="bi bi-person-fill"></i></div>
                                <div class="item-content">
                                    <h3>Hazel Ann Carillo</h3>
                                    <p>Yesterday • 03:18 PM</p>
                                </div>
                                <div class="chevron"><i class="bi bi-chevron-right"></i></div>
                            </div>
                        </div>
